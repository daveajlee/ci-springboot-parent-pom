...
## Version 5.0.0 with Java 25 & Spring Boot 4.1.0
This POM can be used as a Parent POM for any Maven Project wishing to use Spring Boot 4.1, Java 25 and Continuous Integration. You can use the POM as a Parent POM by adding the following code to your POM (assuming you have GitHub packages as a repository already defined):
